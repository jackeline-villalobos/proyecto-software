    ...
    nuevo_organizadorSolicitante.save(
        function(err, organizadorSolicitanteBD){
            if(err){
                ...
                let mailOptions = {
                    from : 'equiponebula2019@gmail.com',
                    to : nuevo_organizadorSolicitante.correo,
                    ...
                    <body>
                        ...
                        <div class="info_credenciales">
                            ...
                            <p>Su contraseña temporal es:  <span> ${nuevo_organizadorSolicitante.contrasenna} </span></p>
                        </div>
                        <br>
                        <br>
                        <hr>
                        <p class="footer">Este mensaje se envió a ${nuevo_organizadorSolicitante.correo}</p>
