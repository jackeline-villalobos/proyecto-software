...
let sltProvincia = document.querySelector('#provincias');
let sltCanton = document.querySelector('#provincias');
...
let eleProvincia = document.querySelector('#provincias');
let eleCanton = document.querySelector('#cantones');
let elDistrito = document.querySelector('#distritos');


eleProvincia.addEventListener('change', llenarCanton);
eleCanton.addEventListener('change', llenarDistrito);
